...
- **Mrrl now tells you.** Open any merchant in Nazjatar and SecretChecklist says
  whether the Crimson Tidestallion is stocked today — or reminds you to equip the
  Azsh'ari Stormsurger Cape first, since without it the special stock is not
  shown at all. Worth knowing before you start a trading chain built from items
